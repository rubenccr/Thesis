...
while(True):
     ...
     client.publish("test/distances", '{},{},{},{},{},{},{}'.format(sys.argv[2],0,4,0,"A193",2,t))
     client.publish("test/distances", '{},{},{},{},{},{},{}'.format(sys.argv[2],2,8,0,"BF13",4,t))
     client.publish("test/distances", '{},{},{},{},{},{},{}'.format(sys.argv[2],4,4,0,"C216",2,t))
