...
with open(var+".txt",'r') as f:
  ...
  with open(var+'.csv', 'w', newline='') as file:
    ...
    writer.writerow(["Anchor/Range","Anchor/Range","Anchor/Range", "Anchor/Range","Estimated"])
    lines = f.readline()
    ...
    while lines != "":
      ...
      if(parsed=="null"):
         ...
         continue
          ...
          #print("writing line")
          writer.writerow([parsed[0], parsed[1], parsed[2],parsed[3],parsed[4]])
